...
const GROUPS: Array<{ title: string; rows: Array<[string[], string]> }> = [
  {
    ...
    rows: [
      ...
      [["+", "−"], "Zoom in / out"],
      [["0"], "Zoom to 100%"],
      [["wheel"], "Pan the canvas vertically"],
      [["shift", "wheel"], "Pan the canvas horizontally"],
      [["ctrl / ⌘", "wheel"], "Zoom around the pointer"],
      [["middle", "drag"], "Pan from either canvas tool"],
      [["Pan", "drag"], "Pan with the hand tool · drag orbs to rearrange"],
    ],
  },
  {
    title: "Explore",
    rows: [
      ...
      [["orb menu"], "Connect the selected artist to another"],
      [["Select", "drag"], "Marquee-select multiple artists"],
      [["shift", "click"], "Add or remove an artist from the selection"],
      [["delete"], "Remove selected artists and their owned branches"],
